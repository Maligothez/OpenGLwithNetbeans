 ...
 *
 * A version of the naive algorithm from Page 93 of Hearn and Baker has been
 * implemented.
 *
 * Your task is to complete the method drawDDALine() and the simple case for
 * drawBresenhamLine().
 *
 * Hot stream: modify drawBresenham() so that it deals correctly with all cases.
 *
 * Superheated stream: Add anti-aliased lines using Xiaolin Wu's algorithm
